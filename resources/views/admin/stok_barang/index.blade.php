    ...
    <div class="col-12 mb-4">
        <div class="card bg-primary text-white shadow">
            <div class="card-body d-flex align-items-center justify-content-between p-4">
                <div>
                    <h5 class="text-white-50 mb-1"><i class="bx bx-archive me-1"></i> Manajemen Inventaris</h5>
                    <h2 class="text-white mb-0 fw-bold">Stok & Bahan Baku</h2>
                    <p class="mb-0 mt-1 text-white-50" style="font-size: 0.85rem; max-width: 600px;">
                        Monitor stok kertas dan bahan baku UP, perbarui persediaan, serta lihat riwayat pemakaian kertas untuk transaksi.
                    </p>
                </div>
