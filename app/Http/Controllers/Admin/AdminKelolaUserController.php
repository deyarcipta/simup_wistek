...
class AdminKelolaUserController extends Controller
{
    ...
    public function downloadSample()
    {
        ...
        if (class_exists(\ZipArchive::class)) {
            ...
            $headers = [
                ...
                'Content-Disposition' => 'attachment; filename="contoh_template_user.csv"',
                'Pragma' => 'no-cache',
                'Expires' => '0',
            ];
            ...
            return response()->stream(function() use ($data) {
                ...
                fputcsv($file, ['Nama', 'Email', 'Role', 'Password (Min 6 Karakter)']);
                foreach ($data as $row) {
                    fputcsv($file, $row);
                }
                fclose($file);
    ...
    public function exportExcel()
    {
        ...
        if (class_exists(\ZipArchive::class)) {
            ...
            $fileName = 'daftar_user_' . date('Ymd_His') . '.csv';
            $headers = [
                'Content-Type' => 'text/csv',
            ...
            return response()->stream(function() use ($users) {
                ...
                fputcsv($file, ['DAFTAR USER SIMUP WISTEK']);
                fputcsv($file, ['Dicetak pada: ' . date('d-m-Y H:i')]);
                fputcsv($file, []); // empty line
                fputcsv($file, ['No', 'Nama', 'Email', 'Role', 'Tanggal Dibuat']);
