    ...
    <div class="col-12 mb-4">
        <div class="card bg-primary text-white shadow">
            <div class="card-body d-flex align-items-center justify-content-between p-4">
                <div>
                    <h5 class="text-white-50 mb-1"><i class="bx bx-credit-card me-1"></i> Manajemen Pengeluaran</h5>
                    <h2 class="text-white mb-0 fw-bold">Biaya Operasional & Lainnya</h2>
                    <p class="mb-0 mt-1 text-white-50" style="font-size: 0.85rem; max-width: 600px;">
                        Catat pengeluaran operasional di luar inventaris utama, biaya tak terduga, dan sisa bagi hasil usaha karyawan.
                    </p>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3 justify-content-end">
                    <div class="col-md-4 col-12">
                        <form action="{{ route('pengeluaran-lain.index') }}" method="GET" class="d-flex">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control form-control-sm" placeholder="Cari keterangan..." value="{{ $search ?? '' }}">
                                <button class="btn btn-primary btn-sm" type="submit">
                                    <i class="bx bx-search"></i>
                                </button>
                                @if(!empty($search))
                                    <a href="{{ route('pengeluaran-lain.index') }}" class="btn btn-secondary btn-sm">
                                        <i class="bx bx-x"></i>
                                    </a>
                                @endif
                            </div>
